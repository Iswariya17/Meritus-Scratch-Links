...
import languagedetectIconURL from './languagedetect/languagedetect.png';
import languagedetectInsetIconURL from './languagedetect/languagedetect-small.png';
...
export default [
    {
        ...
        description: (
            <FormattedMessage
                defaultMessage='ChatGPT for Scratch'
                description='ChatGPT for Scratch'
    ...
    },
    {
        ...
        internetConnectionRequired: true,
        bluetoothRequired: false,
        helpLink: 'https://robotix.github.io/handpose2scratch/'
    },
    {
        name: 'TM w Scratch',
        ...
        translationMap: {
            ...
            'en': {
                'gui.extension.tm2scratchblocks.description': 'AI extn blocks | Teachable Machines'
            },
            'zh-cn': {
    ...
    {
        name: 'LR w Scratch',
        extensionId: 'languagedetect',
        collaborator: 'robotix',
        iconURL: languagedetectIconURL,
        insetIconURL: languagedetectInsetIconURL,
        description: (
            <FormattedMessage
                defaultMessage='AI extn blocks | Language Recognition and Identification'
                description='Languagedetect Blocks.'
                id='gui.extension.languagedetectblocks.description'
            />
        ),
        featured: true,
        disabled: false,
